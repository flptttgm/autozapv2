...
// Custom keyframes for WhatsApp tutorial animation
  ...
  theme: {
    ...
    extend: {
      ...
      keyframes: {
        ...
        // Performance-optimized floating animations (CSS instead of Framer Motion)
        "float-slow": {
        ...
        "float-medium": {
          ...
          "50%": { transform: "translateY(30px) translateX(-40px)", opacity: "0.4" },
        },
        "float-fast": {
