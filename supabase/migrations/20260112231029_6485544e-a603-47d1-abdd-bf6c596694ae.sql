-- Fix the handle_new_user trigger to match current profiles table schema
...
BEGIN
  ...
  -- Create profile (FIXED: removed email column, using workspace_id instead of current_workspace_id)
  ...
  -- Create trial subscription (FIXED: using plan_type instead of plan)
