-- Update handle_new_user function to save whatsapp_number from user metadata
...
BEGIN
  ...
  -- Criar profile vinculado ao workspace com signup_source e whatsapp_number
  INSERT INTO public.profiles (id, full_name, workspace_id, signup_source, whatsapp_number)
  VALUES (
    new.id,
